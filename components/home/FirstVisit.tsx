...
const cards = [
  ...
  },
  {
    ...
    price: `$${SITE.prices.radiografia} c/u`,
  ...
  },
  {
    ...
    items: ['Retenedores fijos y removibles para proteger el resultado', 'Láser de fotobiomodulación Ultradent como complemento premium a Invisalign o brackets', 'Puede ayudar a reducir molestias tras los ajustes y a acortar el tratamiento', 'Se cotiza como add-on al plan de ortodoncia'],
  },
];
    ...
    <section id="evaluacion" className="bg-bg py-[120px] px-8 md:px-[8%]">
      <div className="max-w-[1400px] mx-auto">
        ...
        <h2 className="font-display font-bold text-[clamp(36px,4vw,60px)] text-text leading-[1.1] mb-6">
          Consulta de ortodoncia en San Salvador:<br />
        ...
        <p className="font-body font-light text-[17px] text-muted max-w-[640px] leading-[1.7] mb-16">
          Los precios de Invisalign, brackets y blanqueamiento dependen de cada caso. Lo que sí es fijo es la evaluación con la que empieza todo, y lo que viene después para cuidar el resultado.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {cards.map((card) => (
            <div key={card.title} className="bg-surface rounded-[20px] p-8 border border-dark/5 shadow-[0_2px_24px_rgba(15,76,92,0.06)] flex flex-col">
              ...
              <p className="font-mono text-[13px] text-gold mb-6">{card.price}</p>
